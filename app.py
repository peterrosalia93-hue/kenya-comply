...
<head>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .download-btn { background: #2e7d32; color: white; padding: 14px 24px; border: none; border-radius: 8px; font-size: 1rem; cursor: pointer; width: 100%; margin-top: 15px; font-weight: 600; }
    ...
    <script>
        ...
        document.getElementById('invoiceForm').addEventListener('submit', async (e) => {
            ...
            document.getElementById('invoiceResult').innerHTML = `
                ...
                <button class="download-btn" onclick="downloadInvoice('${result.invoice_number}', '${result.download_text.replace(/'/g, "\\'")}')">📥 Download Invoice</button>
            `;
